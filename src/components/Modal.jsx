    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3 px-5 py-3 border-b border-gray-100 bg-gray-50/70">
          <div>
            <div id={titleId} className="text-base font-semibold text-gray-900">
              {title}
            </div>
            {description && (
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              onClick={onClose}
              aria-label="닫기"
              className="inline-flex size-7 items-center justify-center rounded-md text-gray-400 hover:bg-gray-100 hover:text-gray-600"
            >
              <X size={17} />
            </button>
          </div>
        </div>
        <div className="min-h-0 overflow-x-hidden overflow-y-auto px-5 py-3">{children}</div>
        {footer && (
          <div className="flex justify-end gap-2 px-5 py-2.5 border-t border-gray-100 bg-gray-50/40">
            {footer}
          </div>
        )}
      </div>
